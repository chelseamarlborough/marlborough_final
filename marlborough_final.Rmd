...
# I APOLOGIZE. I HAVE SWITCHED PAPERS MULTIPLE TIMES IN THE LAST MONTH/WEEK SO I
# CONSTANTLY LEARNING NEW MATERIAL AND TRYING TO CATCH UP. THIS IS LITERALLY
# JUST SOME FIGURES AND MY EXTENSION. I AM GOING TO WORK ON AESTHETICS LATER.
...
```{r table 1a made, results="asis"}

library(stargazer)

stargazer(mod_1, mod_3, mod_5, mod_7, mod_9, mod_11, type = "latex", add.lines = list(c("Fixed effects?", "Y", "Y”, Y", "Y", "Y", "Y")), title = "Effects of Wind Turbines on Incumbent Party Vote Share in Precincts")

```

```{r table 1b made, results="asis"}

stargazer(mod_2, mod_4, mod_6, mod_8, mod_10, mod_12, type = "latex", add.lines = list(c("Fixed effects?", "Y", "Y”, Y", "Y", "Y", "Y")), title = "Effects of Wind Turbines on Incumbent Party Vote Share in Precincts")
