...
mod_1 <-stan_glm(vote ~ prop + Y2003 + Y2007, data = yx_diffed, refresh = 0, family = "binomial")
...
mod_2 <- stan_glm(vote ~ op + Y2003 + Y2007, data = yx_diffed, family = "binomial", refresh = 0)
...
mod_5 <- stan_glm(vote ~ prop + Y2003 + Y2007, data = yx_diffed, family = "binomial", refresh = 0)
...
mod_9 <-
  stan_glm(vote ~ prop + Y2003 + Y2007,
     data = yx_diffed, family = "binomial", refresh = 0,
     weights = divisions$weights_p) 
...
```{r table 1 regressions, include = FALSE}
